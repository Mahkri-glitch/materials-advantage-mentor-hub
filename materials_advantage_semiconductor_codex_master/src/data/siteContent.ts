...
export const faculty = [
  { name: "Parag Banerjee", title: "Professor", area: "Atomic layer deposition and etching, thin films, catalysis, semiconductor processing", studentAngle: "Process science, surface reactions, in situ characterization, and atomic-scale manufacturing." },
  { name: "Chase Brown", title: "Assistant Professor", area: "Nanomaterials, photonics, bioinformatics, machine learning, and automated discovery", studentAngle: "Experimental materials science combined with AI and high-throughput discovery." },
  { name: "Needa Brown", title: "Assistant Professor", area: "Nanobiomaterials, infectious disease, biointerfaces, and therapeutic materials", studentAngle: "Materials research at the interface of engineering, biology, and health." },
  { name: "Kaitlyn Crawford", title: "Associate Professor", area: "Polymer science, soft materials, biointerfaces, and surface chemistry", studentAngle: "Synthesis and characterization of functional polymers and biologically relevant interfaces." },
  { name: "Kris Davis", title: "Associate Professor", area: "Photovoltaics, semiconductor reliability, manufacturing, and data-enabled process control", studentAngle: "Solar-cell processing, characterization, degradation, and manufacturing analytics." },
  { name: "Yajie Dong", title: "Associate Professor", area: "Optoelectronic materials, perovskites, LEDs, displays, and nanophotonics", studentAngle: "Solution-processed electronic materials and light-emitting device fabrication." },
  { name: "Jiyu Fang", title: "Professor", area: "Nanomaterials, self-assembly, soft matter, and advanced characterization", studentAngle: "Creating and characterizing nanoscale structures with controlled properties." },
  { name: "James Fenton", title: "Professor", area: "Electrochemical engineering, fuel cells, hydrogen, and energy systems", studentAngle: "Applied electrochemistry and materials challenges in clean-energy technologies." },
  { name: "Paria Gharavi", title: "Assistant Professor", area: "Mechanics and manufacturing of architected and multifunctional materials", studentAngle: "Connecting microstructure, processing, mechanics, and advanced manufacturing." },
  { name: "Tengfei Jiang", title: "Associate Professor", area: "Electronic packaging, interconnects, reliability, solder, and additive manufacturing", studentAngle: "Semiconductor packaging, failure mechanisms, manufacturing, and characterization." },
  { name: "Yeonwoong Eric Jung", title: "Associate Professor", area: "Two-dimensional materials, nanomanufacturing, flexible electronics, and devices", studentAngle: "Growth, processing, and device integration of emerging semiconductor materials." },
  { name: "Akihiro Kushima", title: "Associate Professor", area: "In situ electron microscopy, batteries, interfaces, mechanics, and computational materials", studentAngle: "Observing nanoscale reactions and degradation while they occur." },
  { name: "Sidong Lei", title: "Associate Professor", area: "Two-dimensional and quantum materials, van der Waals interfaces, and electronic devices", studentAngle: "Nanoscale device fabrication and interface engineering for emerging electronics." },
  { name: "Lorraine Leon", title: "Associate Professor", area: "Biomolecular engineering, polymers, proteins, and self-assembled materials", studentAngle: "Designing soft and biomolecular materials through molecular interactions." },
  { name: "David Mitchell", title: "Associate Professor", area: "Extreme-environment materials, high-temperature behavior, aerospace materials, and mechanics", studentAngle: "Materials testing and degradation under demanding thermal and mechanical conditions." },
  { name: "Kausik Mukhopadhyay", title: "Assistant Professor", area: "Computational materials, multiscale modeling, data science, and mechanics", studentAngle: "Using simulation and data to connect atomic behavior with engineering performance." },
  { name: "Leland Nordin", title: "Assistant Professor", area: "Semiconductor photonics, optoelectronic devices, nanofabrication, and integrated optics", studentAngle: "Fabricating and testing photonic and semiconductor devices." },
  { name: "Aleksandra Petelski", title: "Assistant Professor", area: "Biomaterials, mechanobiology, tissue interfaces, and computational bioengineering", studentAngle: "Understanding how engineered materials interact with cells and biological systems." },
  { name: "Mohiuddin Quadir", title: "Associate Professor", area: "Polymer synthesis, drug delivery, regenerative medicine, and biomedical materials", studentAngle: "Designing functional polymers for therapeutic and regenerative applications." },
  { name: "Rachna Rachna", title: "Lecturer", area: "Green synthesis, nanomaterials, environmental remediation, and materials education", studentAngle: "Sustainable nanomaterial synthesis and environmental applications." },
  { name: "Swaminathan Rajaraman", title: "Associate Professor", area: "Microfabrication, biosensors, wearable systems, MEMS, and biomedical devices", studentAngle: "Cleanroom fabrication and integration of microsystems for health and sensing." },
  { name: "Yuxun Ren", title: "Assistant Professor", area: "Energy storage, batteries, electrochemistry, mechanics, and multifunctional structures", studentAngle: "Battery materials, structural energy storage, and electrochemical-mechanical coupling." },
  { name: "Sudipta Seal", title: "Professor and Department Chair", area: "Nanobiomaterials, nanomanufacturing, ceramics, catalysis, and biomedical applications", studentAngle: "Translational nanomaterials spanning health, energy, and environmental applications." },
  { name: "Viktoryia Shautsova", title: "Assistant Professor", area: "Low-dimensional materials, quantum and optoelectronic phenomena, and nanophotonics", studentAngle: "Optical and electronic properties of nanoscale and quantum material systems." },
  { name: "Yongho Sohn", title: "Pegasus Professor", area: "Metallurgy, additive manufacturing, phase transformations, diffusion, and high-temperature materials", studentAngle: "Processing–structure–property relationships in alloys and additively manufactured metals." },
  { name: "Jayan Thomas", title: "Professor", area: "Nanophotonics, energy storage, optical materials, sensors, and additive nanomanufacturing", studentAngle: "Functional materials for photonics, energy, and advanced manufacturing." },
  { name: "Raj Vaidyanathan", title: "Professor", area: "Shape-memory alloys, mechanical behavior, structural materials, and biomedical devices", studentAngle: "Mechanical testing and phase transformations in smart and structural materials." },
  { name: "Shruti Vyas", title: "Assistant Professor", area: "Materials informatics, machine learning, computational materials, and autonomous experimentation", studentAngle: "Data-driven tools for materials prediction and discovery." },
  { name: "Yang Yang", title: "Associate Professor", area: "Energy materials, catalysis, electrochemistry, interfaces, and nanomaterials", studentAngle: "Synthesizing and characterizing materials for energy conversion and storage." },
  { name: "Liping Yu", title: "Associate Professor", area: "Computational materials, semiconductor theory, defects, electronic structure, and informatics", studentAngle: "Predicting electronic materials and defect behavior using computation and data." },
  { name: "Dan Zhou", title: "Instructor", area: "Materials engineering education and laboratory instruction", studentAngle: "Foundational materials characterization, laboratory practice, and engineering education." },
] as const;
